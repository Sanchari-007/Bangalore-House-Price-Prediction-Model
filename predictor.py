...
Original file is located at
    https://colab.research.google.com/drive/12eDNjISOEqJbaCuwR07fK84GsJ70h3rw
"""
...
ne_dum = pd.get_dummies(data1['location'])
ne_dum = ne_dum.astype(int)
data1 = pd.concat([data, ne_dum], axis=1)
